...
public final class LayoutProductItemBinding implements ViewBinding {
  ...
  private LayoutProductItemBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull Button button2, @NonNull Guideline guideline, @NonNull ImageView imageView2,
  ...
  public static LayoutProductItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutProductItemBinding((ConstraintLayout) rootView, button, button2, guideline,
          imageView2, textView, textView3, textView4);
    }
