...
public final class ActivityProductDetailsBinding implements ViewBinding {
  ...
  private ActivityProductDetailsBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageSlider imageSlider, @NonNull MaterialCardView materialCardView,
  ...
  public static ActivityProductDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityProductDetailsBinding((ConstraintLayout) rootView, imageSlider,
          materialCardView, textView10, textView7, textView8, textView9);
    }
